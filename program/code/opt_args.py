...
class OptArg:
    ...
    #CURRENTLY in testing so code still uses old format for storing parameters.
    #TODO complete class and test it. Then actually make otyher classes use it.
